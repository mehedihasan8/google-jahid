      ...
      <div className="">
        ...
        <div className="pp my-10  md:mb-32 mt-8 border rounded-lg p-4 md:p-8">
          ...
          <div className="privacy-text    mb-6">
            ...
            communication between you and ToolsFinder <br />
            <br />
            Under no circumstances shall ToolsFinder team be liable for any
            ...
            even if ToolsFinder team or an authorized representative has been
            ...
            <br />
            <br />
            ToolsFinder will not be responsible for any outcome that may occur
          ...
          <div className="privacy-text mb-6">
            ToolsFinder grants you a revocable, non-exclusive, non-transferable,
            limited license to download, install and use the website strictly in
            accordance with the terms of this Agreement.
            <br /> <br />
            These Terms & Conditions are a contract between you and ToolsFinder
            (referred to in these Terms & Conditions as "ToolsFinder", "us",
            "we" or "our"), the provider of the ToolsFinder website and the
            services accessible from the ToolsFinder website (which are
            ...
            ToolsFinder Service. In these Terms & Conditions, "you" refers both
          ...
          <div className="privacy-text mb-6  ">
            ...
            <ul>
              ...
              <li className="list-item">
                ...
                “our,” it refers to Vivek Varma, (Ashok Nagar, Bangalore,
                560025), that is responsible for your information under this
                Terms & Conditions.
              </li>
              <li className="list-item">
                Country: where ToolsFinder or the owners/founders of ToolsFinder
              ...
              <li className="list-item">
                ...
                ToolsFinder and use the services.
              </li>
              <li className="list-item">
                Service: refers to the service provided by ToolsFinder as
          ...
          <div className="privacy-text mb-6  ">
            ...
            <ul className="mt-4">
              ...
              <li className="list-item">
                ...
                notice of copyright or trademark) of ToolsFinder or its
          ...
          <div className="privacy-text mb-6  ">
            ...
            Provider. By providing ToolsFinder with your credit card number and
            associated payment information, you agree that ToolsFinder is
            ...
            ToolsFinder hereunder and that no additional notice or consent is
            required. You agree to immediately notify ToolsFinder of any change
            in your billing address or the credit card used for payment
            hereunder. ToolsFinder reserves the right at any time to change its
            prices and billing methods, either immediately upon posting on our
            Site or by e-mail delivery to your organization’s administrator(s).
            <br />
            <br />
            ...
            <br />
            <br />
            No contract will exist between you and ToolsFinder for the Service
            until ToolsFinder accepts your order by a confirmatory e-mail,
          ...
          <div className="privacy-text mb-6  ">
            Thanks for shopping at ToolsFinder. We appreciate the fact that you
            ...
            apply to transactions at ToolsFinder. We’ll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at ToolsFinder, you agree to the terms
            along with ToolsFinder Privacy Policy.
            <br />
            <br />
          ...
          <div className="privacy-text mb-6  ">
            ...
            (collectively, "Suggestions") provided by you to ToolsFinder with
            respect to the website shall remain the sole and exclusive property
            of ToolsFinder.
            <br />
            <br />
            ToolsFinder shall be free to use, copy, modify, publish, or
          ...
          <div className="privacy-text mb-6  ">
            ...
            ToolsFinder. We are not responsible for the content, accuracy or
          ...
          <div className="privacy-text mb-6  ">
            ToolsFinder uses "Cookies" to identify the areas of our website that
          ...
          <div className="privacy-text mb-6  ">
            You acknowledge and agree that ToolsFinder may stop (permanently or
            temporarily) providing the Service (or any features within the
            Service) to you or to users generally at ToolsFinder sole
            discretion, without prior notice to you. You may stop using the
            Service at any time. You do not need to specifically inform
            ToolsFinder when you stop using the Service. You acknowledge and
            agree that if ToolsFinder disables access to your account, you may
          ...
          <div className="privacy-text mb-6  ">
            ToolsFinder reserves the right to modify, suspend or discontinue,
          ...
          <div className="privacy-text mb-6  ">
            ToolsFinder may from time to time provide enhancements or
            ...
            of the website. You agree that ToolsFinder has no obligation to (i)
          ...
          <div className="privacy-text mb-6  ">
            ...
            <br />
            <br />
            You acknowledge and agree that ToolsFinder shall not be responsible
            for any Third-Party Services, including their accuracy,
            completeness, timeliness, validity, copyright compliance, legality,
            decency, quality or any other aspect thereof. ToolsFinder does not
          ...
          <div className="privacy-text mb-6  ">
            ...
            ToolsFinder. ToolsFinder may, in its sole discretion, at any time
            ...
            ToolsFinder, in the event that you fail to comply with any provision
            ...
            <br />
            <br />
            Termination of this Agreement will not limit any of ToolsFinder
          ...
          <div className="privacy-text mb-6  ">
            ...
            liability of ToolsFinder and any of its suppliers under any
            ...
            ToolsFinder or its suppliers be liable for any special, incidental,
            ...
            ToolsFinder or any supplier has been advised of the possibility of
          ...
          <div className="privacy-text mb-6  ">
            ...
            notices published by ToolsFinder on the Services, shall constitute
            the entire agreement between you and ToolsFinder concerning the
            ...
            waiver of such term or any other term, and ToolsFinder failure to
            assert any right or provision under this Agreement shall not
            constitute a waiver of such right or provision. YOU AND ToolsFinder
          ...
          <div className="privacy-text mb-6  ">
            ToolsFinder reserves the right, at its sole discretion, to modify or
          ...
          <div className="privacy-text mb-6  ">
            ...
            property of ToolsFinder without any compensation or credit to you
            whatsoever. ToolsFinder and its affiliates shall have no obligations
          ...
          <div className="privacy-text mb-6  ">
            ToolsFinder may, from time to time, include contests, promotions,
          ...
          <div className="privacy-text mb-6  ">
            ...
            signed by an authorized representative of ToolsFinder. ToolsFinder
            ...
            breach or anticipatory breach by you. ToolsFinder operates and
            controls the ToolsFinder Service from its offices in India. The
            ...
            who choose to access the ToolsFinder Service from other locations do
            ...
            ToolsFinder Privacy Policy) contains the entire understanding, and
            supersedes all prior understandings, between you and ToolsFinder
          ...
          <div className="privacy-text mb-6  ">
            ToolsFinder is not responsible for any content, code or any other
            imprecision. ToolsFinder does not provide warranties or guarantees.
            In no event shall ToolsFinder be liable for any special, direct,
            ...
            whether express or implied. ToolsFinder is a distributor and not a
            publisher of the content supplied by third parties; as such,
            ToolsFinder exercises no editorial control over such content and
            ...
            provided through or accessible via the ToolsFinder Service. Without
            limiting the foregoing, ToolsFinder specifically disclaims all
            warranties and representations in any content transmitted on or in
            connection with the ToolsFinder Service or on sites that may appear
            as links on the ToolsFinder Service, or in the products provided as
            a part of, or otherwise in connection with, the ToolsFinder Service,
            including without limitation any warranties of merchantability,
            fitness for a particular purpose or non-infringement of third party
            rights. No oral advice or written information given by ToolsFinder
            ...
            ToolsFinder does not warrant that the ToolsFinder Service will be
