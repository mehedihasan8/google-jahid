    ...
    <div>
      ...
      <div className="pp my-10  md:mb-32 mt-8 border rounded-lg p-4 md:p-8">
        ...
        <div className="privacy-text mb-6">
          ...
          communication between you and GoodTools.Ai <br />
          <br />
          ...
          even if GoodTools.Ai team or an authorized representative has been
        ...
        <div className="privacy-text mb-6">
          ...
          (referred to in these Terms & Conditions as "GoodTools.Ai", "us",
          "we" or "our"), the provider of the GoodTools.Ai website and the
          services accessible from the GoodTools.Ai website (which are
          collectively referred to in these Terms & Conditions as the
          "GoodTools.Ai Service").
          <br />
          <br />
        ...
        <div className="privacy-text mb-6  ">
          ...
          Provider. By providing GoodTools.Ai with your credit card number and
          associated payment information, you agree that GoodTools.Ai is
          ...
          GoodTools.Ai hereunder and that no additional notice or consent is
          required. You agree to immediately notify GoodTools.Ai of any change
          in your billing address or the credit card used for payment
          hereunder. GoodTools.Ai reserves the right at any time to change its
        ...
        <div className="privacy-text mb-6  ">
          ...
          an order or making a purchase at GoodTools.Ai, you agree to the terms
        ...
        <div className="privacy-text mb-6  ">
          ...
          Service) to you or to users generally at GoodTools.Ai sole
          discretion, without prior notice to you. You may stop using the
          Service at any time. You do not need to specifically inform
          GoodTools.Ai when you stop using the Service. You acknowledge and
          agree that if GoodTools.Ai disables access to your account, you may
        ...
        <div className="privacy-text mb-6  ">
          ...
          decency, quality or any other aspect thereof. GoodTools.Ai does not
        ...
        <div className="privacy-text mb-6  ">
          ...
          liability of GoodTools.Ai and any of its suppliers under any
          ...
          GoodTools.Ai or any supplier has been advised of the possibility of
        ...
        <div className="privacy-text mb-6  ">
          ...
          property of GoodTools.Ai without any compensation or credit to you
          whatsoever. GoodTools.Ai and its affiliates shall have no obligations
        ...
        <div className="privacy-text mb-6  ">
          ...
          signed by an authorized representative of GoodTools.Ai. GoodTools.Ai
          ...
          breach or anticipatory breach by you. GoodTools.Ai operates and
          controls the GoodTools.Ai Service from its offices in India. The
          ...
          who choose to access the GoodTools.Ai Service from other locations do
          ...
          GoodTools.Ai Privacy Policy) contains the entire understanding, and
          supersedes all prior understandings, between you and GoodTools.Ai
        ...
        <div className="privacy-text mb-6  ">
          ...
          <br />
          <br />
          The GoodTools.Ai Service and its contents are provided "as is" and
          ...
          provided through or accessible via the GoodTools.Ai Service. Without
          limiting the foregoing, GoodTools.Ai specifically disclaims all
          warranties and representations in any content transmitted on or in
          connection with the GoodTools.Ai Service or on sites that may appear
          as links on the GoodTools.Ai Service, or in the products provided as
          a part of, or otherwise in connection with, the GoodTools.Ai Service,
          including without limitation any warranties of merchantability,
          fitness for a particular purpose or non-infringement of third party
          rights. No oral advice or written information given by GoodTools.Ai
          ...
          GoodTools.Ai does not warrant that the GoodTools.Ai Service will be
