      ...
      <div className="md:px-10 w-full md:mt-[20px] mt-6">
        ...
        <div className="md:grid grid-cols-2 mb-20 md:h-[375px] gap-x-20 hide-scrollbar">
          <div className="hide-scrollbar ">
            ...
            <div className="md:flex text-center items-center pb-6 md:pb-[30px] border-b border-[#E5E7EB]">
              ...
              <Rating
                ...
                readOnly
              />
              <span className="text[#4D5761] text-base font-paragraph text-[#4D5761] font-normal block text-center mt-2">
                Based on {reviews.length} rating
              </span>
            </div>

            <p className="text-[#081120]  text-xl font-medium my-[30px]">
              Overall Rating
            </p>
          ...
          <div className="relative">
            ...
            <div className="md:absolute top-0 right-0 p-[40px] mt-7 md:mt-0 border rounded-[20px] w-full md:w-[100%] h-fit md:h-fit">
              <div className="text-2xl text-[#081120] font-bold mb-[20px]">
                What do you think about {name}?
              </div>
              <div className="text-sm font-normal text-[#4D5761]  mb-[32px]">
                If you have a moment, it would be greatly appreciated if you
                <br />
                could leave a review to share your thoughts with the
                <br />
                community. Your feedback is valuable to us and helps us
                <br />
              ...
              <div onClick={handleClick} className="w-full flex justify-center">
                <button className="border border-[#E5E7EB] rounded-xl mt-[6px] px-[34px] py-[16px] flex items-center justify-center w-fit">
                  <span className="text-base font-medium mr-4 text-[#4D5761]">
                    Rate {name}
                  </span>
                  <svg
                    className="h-5"
        ...
        >
          ...
          <div className="md:grid grid-cols-2 mb-14 relative">
            <SingleReview
              name={reviews[reviewCount]?.name}
              rating={reviews[reviewCount]?.rating}
              date={reviews[reviewCount]?.date}
              comment={reviews[reviewCount]?.comment}
            ></SingleReview>

            {reviews[reviewCount + 1] ? (
              <div className="md:absolute top-0 right-0 hidden md:block">
                <SingleReview
                  name={reviews[reviewCount + 1]?.name}
                  rating={reviews[reviewCount + 1]?.rating}
                  date={reviews[reviewCount + 1]?.date}
                  comment={reviews[reviewCount + 1]?.comment}
                ></SingleReview>
              </div>
            ) : (
              <div></div>
