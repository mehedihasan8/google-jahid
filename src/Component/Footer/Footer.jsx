...
const Footer = () => {
  return (
    <div className='md:h-[318px] h-fit bg-[#F9FAFB] mx-4 md:mx-0 my-10 md:my-0 pb-[40px] md:pb-0'>
      <div className='font-paragraph bg-[#F9FAFB]  md:pt-[80px] pt-[64px] md:pb-[60px] w-full' >
        <footer className=" mt-6 md:mt-0 md:max-w-[1170px] w-full text-base font-paragraph mx-auto grid md:grid-cols-3 grid-cols-2 ">

          <div className='h-[94px] w-full my-auto border-r md:border-0 border-[#D2D6DB]'>
            <Link href='/privacy-policy' className="link link-hover block mb-[11px]">Privacy Policy</Link>
            <Link href="/terms" className="link link-hover nav-text block mb-[11px]">Term of Service</Link>
            <Link href='/about' className="link mb-7 link-hover nav-text block">About Us</Link>
          </div>

          <div className='h-[94px]  w-full flex flex-col items-center my-auto '>
            <div className='text-left'>

              <Link href='/contact' className="link link-hover nav-text block mb-[11px]">Contact</Link>
              <Link href='/about' className="link mb-7 link-hover nav-text block">Request A Feature</Link>
            </div>
          </div>

          <div className='md:h-[94px] h-[60px] w-full flex flex-col md:col-span-1 col-span-2 md:items-end items-center md:my-auto mt-6 md:mt-0'>
            <div className='flex flex-col md:items-start items-center'>
              ...
              <div className="flex justify-between items-center w-[152px]">
                <a href="" className='bg-[#5865F2] w-[26px] h-[26px] flex items-center justify-between rounded-full pl-[5px]'>
                ...
                <a href='' className=' w-[26px] h-[26px] flex items-center justify-between rounded-full'>
      ...
      <hr className='md:max-w-[1170px] mx-auto bg-[#D2D6DB] mt-6 mb:mt-0 md:mb-0' />
      <div className='h-[44px] flex place-items-end'>
        <p className='text-center w-full text-base font-paragraph'>Copyright © 2023 - ToolsFinder</p>
      </div>
    </div>
